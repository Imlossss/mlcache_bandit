...
#define __NR_syscall_max 332 /* sizeof(syscalls_64) - 1 */
#define NR_syscalls 333 /* sizeof(syscalls_64) */
#define __NR_syscall_compat_max 384 /* sizeof(syscalls_ia32) - 1 */
#define IA32_NR_syscalls 385 /* sizeof(syscalls_ia32) */

#define TASK_threadsp 2464 /* offsetof(struct task_struct, thread.sp) */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags) */
#define TASK_addr_limit 2600 /* offsetof(struct task_struct, thread.addr_limit) */
